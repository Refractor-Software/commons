#ifndef     REFRACTOR_CORE_DETAIL_WIN64_CORE_H
#define     REFRACTOR_CORE_DETAIL_WIN64_CORE_H
...
#include "direct.h"
#define r_file_get_cwd _getcwd

#endif  /*  REFRACTOR_CORE_DETAIL_WIN64_CORE_H  */
